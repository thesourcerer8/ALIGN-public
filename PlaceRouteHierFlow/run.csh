#time PNRDB_disable_io=1 PNRDB_SAVE_STATE=1 ./pnr_compiler ./cascode_current_mirror_ota cascode_current_mirror_ota.lef cascode_current_mirror_ota.v cascode_current_mirror_ota.map layers.json cascode_current_mirror_ota 1 0 1 1 1 1 | tee log
time PNRDB_disable_io=1 PNRDB_SAVE_STATE=1 ./pnr_compiler ./ota_asap7 ota_asap7.lef ota_asap7.v ota_asap7.map layers.json ota_asap7 1 0 1 1 1 1 1 1 | tee log
